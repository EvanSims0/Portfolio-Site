...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Stat pills */}
      <div className="animate-fade-up delay-700 flex flex-wrap gap-3 mt-20">
        {[
          ...
          <div
            key={label}
            className="flex items-center gap-2.5 border border-surface/35 rounded-full px-5 py-2 text-xs font-body text-text-muted bg-surface/10"
          >
