...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-48 px-6 pb-24" ref={ref}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Contact cards */}
        <div
          className={`mt-14 grid grid-cols-1 sm:grid-cols-3 gap-5 transition-all duration-700 ${
        ...
        >
          {LINKS.map(({ label, value, href, icon, cta }) => (
            <a
              ...
              className="card-glow group border border-surface/30 rounded-none p-6 bg-surface-dim/40 flex flex-col gap-4 transition-all duration-200 border-t-2 border-t-accent/40"
            >
              <div className="w-10 h-10 rounded-none bg-accent/10 border border-accent/25 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all duration-200">
                {icon}
              </div>
              <div>
        ...
        >
          <button
            onClick={copyEmail}
            className="inline-flex items-center gap-2 font-body text-xs text-text-muted hover:text-text border border-surface/25 hover:border-surface/40 rounded-none px-4 py-2 transition-all duration-200"
          >
            {copied ? (
              <>
